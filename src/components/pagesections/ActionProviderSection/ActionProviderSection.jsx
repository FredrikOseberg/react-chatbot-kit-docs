    ...
    <div className='app-actionprovider-section'>
      ...
      <div className='app-actionprovider-section-docs-container'>
        <div className='app-actionprovider-section-docs-inner-container'>
          ...
          >
            <p>
              The actionprovider controls what kind of action that the
              chatbot is going to perform. The actionprovider is given the
          ...
          <DocsContainer title='createChatBotMessage'>
            <p>
              The createChatBotMessage constructs a chatBotMessage that you
              can insert into the chatbots state. It defines the chat
              message response, and defines whether or not you want to
              render any custom components (widgets) with the response.
          ...
          <DocsContainer title='createClientMessage'>
            <p>
              ...
              actionprovider in order to simulate a user message. It takes
              only a message parameter as input.
