        ...
        <div className='app-config-section-docs-inner-container'>
          ...
          >
            <p>
              ...
              chatbot to work is a config that includes the
              "initialMessages" property. It instructs the chatbot what
              messages to display on render.
            </p>
          </DocsContainer>
          ...
          <DocsContainer title='Properties'>
            <ul className='app-config-section-docs-list'>
              ...
              <li className='app-config-section-docs-listitem'>
                initialMessages - defines an array of initial messages from
                the bot. Required property.
              </li>
              <li className='app-config-section-docs-listitem'>
              ...
              <li className='app-config-section-docs-listitem'>
                customComponents - you can define your own components and
                swap out the components that come with react-chatbot-kit by
                replacing them here. For example if you want your own
                custom chatmessage component for the bot.
              </li>
              <li className='app-config-section-docs-listitem'>
                widgets - here you can define a list of widgets that you
                want to be able to render with a chatbot response. See the
