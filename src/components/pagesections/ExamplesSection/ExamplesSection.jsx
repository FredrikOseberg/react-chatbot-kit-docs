      ...
      <div className='app-examples-docsbot'>
        <div className='app-examples-docsbot-container'>
          <div className='app-examples-docsbot-description'>
            <h1>Docsbot</h1>
            <p>
              DocsBot is your friendly neighbourhood bot who is not only
              built with this package, but is eager to help you understand
      ...
      <div className='app-examples-skybot'>
        <div className='app-examples-skybot-container'>
          ...
          <div className='app-examples-skybot-description'>
            <h1>Skybot</h1>
            <p>
              Skybot is the bot that sparked the idea for this package. It
              was originally built as a proof of concept and exploration of
              cloud services, but quickly morphed into this package.
            </p>
            <GithubLink
              linkText='View source code'
