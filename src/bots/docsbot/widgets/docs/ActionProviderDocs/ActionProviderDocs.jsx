        ...
        show={
          <InformationBox setState={setState}>
            <p className={styles.infoBoxParagraph}>
              ...
              functions that you want to call in response to a user input.
              The actionprovider is given to the messageparser so you can
              use any methods you provide here inside the messageparser.
            </p>
            <p className={styles.infoBoxParagraph}>
