...
import DepartureFlight from '../../icons/plane-departure.svg';
import ArrivalFlight from '../../icons/plane-arrival.svg';
import Arrows from '../../icons/arrows-h.svg';
  ...
  return (
    <div className='single-flight-container'>
      <div className='single-flight-header'>
        ...
        <h2 className='single-flight-heading'>
